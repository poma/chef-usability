...
default['usability']['packages-wsl'] = %w{locate build-essential autoconf automake vagrant mysql-client ruby python python-pip nodejs npm openjdk-8-jre dotnet-runtime-2.0.0 google-cloud-sdk php7.1 php7.1-cli php7.1-curl php7.1-xml php7.1-zip php7.1-gd php7.1-mysql php7.1-mbstring memcached composer}
